...
%%%%(c)
%%%%(c)
\chapter{Cosets and Quotient Groups (a.k.a. Factor Groups)\quad
\sectionvideohref{L19Zo2BOFBQ&list=PL2uooHqQ6T7PW5na4EX8rQX2WvBBdM8Qo&index=28}}\label{cosets}
...
\begin{example}\label{example:cosets:ModArith}\emph{(Modular addition d\'ej\`a vu all over again)}  
...
\begin{exercise}\label{exercise:cosets:equiv_class_mod5}
\begin{enumerate}[(a)]
\item
...
\begin{exercise}\label{exercise:cosets:Z6_cosets}
...
\begin{exercise}\label{exercise:cosets:left_right_cosets}
...
\begin{prop}\label{proposition:cosets:cosets_theorem_1}
...
\begin{exercise}\label{exercise:cosets:CosetEquiv}
\begin{enumerate}[(a)]
\item
...
\begin{exercise}\label{exercise:cosets:equiv_conditions}
...
\begin{prop}\label{proposition:cosets:cosets_theorem_2}
...
\item
\begin{exercise}\label{exercise:cosets:disjoint_union_proof}
...
\begin{exercise}\label{exercise:cosets:Z6_right_index}
...
\begin{exercise}\label{exercise:cosets:S3_right_index}
How many right cosets of  $H = \{ (1),(123), (132) \}$ in $S_3$ were there?  How about right cosets of  $K= \{ (1), (12) \}$ in $S_3$?
\end{exercise}

\begin{exercise}\label{exercise:cosets:index_right_cosets}
...
\begin{prop}\label{proposition:cosets:cosets_theorem_3}
...
\begin{exercise}\label{exercise:cosets:SL2_cosets}
...
\begin{prop}\label{proposition:cosets:cosets_theorem_4}
...
\begin{prop}\label{proposition:cosets:LagrangeTheorem}(\term{Lagrange's theorem})
...
\begin{exercise}\label{exercise:cosets:order5and7}
...
\begin{exercise}\label{exercise:cosets:finite_60}
...
\begin{prop}\label{proposition:cosets:cosets_theorem_8}
...
\begin{prop}\label{proposition:cosets:cosets_theorem_6}
...
\begin{exercise}\label{exercise:cosets:phivals}
...
\begin{prop}\label{proposition:cosets:cosets:Eulers_theorem} (\emph{Euler's theorem}) \index{Euler's theorem}
...
\begin{exercise}\label{exercise:cosets:modvals}
...
\begin{exercise}\label{exercise:cosets:FermatLittle}
...
\begin{exercise}\label{exercise:cosets:primeGroups}
...
\begin{prop}\label{proposition:cosets:cosets_theorem_7}
...
\begin{exercise}\label{exercise:cosets:prime_simple}
...
%
%\begin{prop}\label{proposition:cosets:cosets:cycle_length_theorem}
...
%\end{proof}
%
%\begin{exercise}\label{exercise:cosets:conjugate}
...
%
%\begin{exercise}\label{exercise:cosets:NoThreeCycles}
...
%
%\begin{prop}\label{proposition:cosets:cosets_theorem_10}
...
\begin{example}\label{example:cosets:normal_S3}
...
\begin{exercise}\label{exercise:cosets:e_normal}
...
\begin{prop}\label{proposition:cosets:index2_normal} Let $G$ be a group, and let $H$ be a subgroup of $G$ with index 2. Then $H$ is a normal subgroup of $G$.
\end{prop}
\begin{exercise}
...
\begin{exercise}\label{exercise:cosets:abelian_normal} Prove that any subgroup of an abelian group is normal.
\hyperref[sec:cosets:hints]{(*Hint*)}
\end{exercise}
...
\begin{prop}\label{proposition:cosets:cosetNormal} Let $H$ be a subgroup of $G$. Then $H$ is normal iff every left coset of $H$ is also a right coset of $H$.
\end{prop}
\begin{exercise}
...
\begin{prop}\label{proposition:cosets:normal:normalequivalents}
...
\begin{exercise}\label{exercise:cosets:ghg-1_prove}
...
\begin{exercise}\label{exercise:cosets:normalk}
...
\begin{exercise}\label{exercise:cosets:normal_mult}
\begin{enumerate}[(a)]
\item
...
\begin{example}\label{example:cosets:factor_Z3}
...
\begin{prop}\label{proposition:cosets:norm_comp}
...
\begin{example}\label{example:cosets:factor_S3}
...
\begin{exercise}\label{exercise:cosets:factor_cayley_prac}
...
\begin{example}\label{example:cosets:factor_Dn}
...
\begin{exercise}\label{exercise:cosets:cayley_dn_rn}
...
\begin{exercise}\label{exercise:cosets:Sn_NotSimple}
...
\begin{prop}\label{proposition:cosets:normal:3cycle_lemma1}
...
Before continuing onward with our proof, let's do a few examples to see how this works.
 ...
 \begin{exercise}\label{exercise:cosets:ex3cycle}
...
\begin{prop}\label{proposition:cosets:normal:3cycle_lemma2}
...
\begin{prop}\label{proposition:cosets:normal:3cycle_lemma3}
...
\begin{prop}\label{proposition:cosets:normal:An_simple}
