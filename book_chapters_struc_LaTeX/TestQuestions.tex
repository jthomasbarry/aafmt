\chapter{Example Test Questions}\label{Practice}
...
\item
According to Proposition~\ref{proposition:EquivalenceRelationsChap:EquivRel->Part}, this equivalence relation produces a partition on  $\ZZ_8$. List the sets in the partition.
\end{enumerate}
