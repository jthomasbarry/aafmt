...
\chapter{Equivalence Relations and Equivalence Classes}\label{EquivalenceRelationsChap}
...
\begin{example}\label{example:EquivalenceRelationsChap:bbal}
...
\begin{exercise}\label{exercise:EquivalenceRelationsChap:bball_subsets}
...
\begin{example}\label{example:EquivalenceRelationsChap:r2relation}
...
\begin{example}\label{example:EquivalenceRelationsChap:ex_rel}
...
\begin{example}\label{example:EquivalenceRelationsChap:cities}
...
\begin{exercise}\label{exercise:EquivalenceRelationsChap:notbinary}
...
\end{defn}
 ...
 \begin{example}\label{example:EquivalenceRelationsChap:digraph1}
...
\end{example}
 ...
 \begin{exercise}\label{exercise:EquivalenceRelationsChap:DrawBinRelExer1}
Choose your favorite NBA team, and find a team roster (a good place to look is ESPN.com). Choose 6 players that have complete data, and let that be your set $A$.  draw a digraph for each of the following binary relations on~$A$: 
 ...
 \begin{exercise}\label{exercise:EquivalenceRelationsChap:DrawBinRelExer3}
...
$ R_d = \{\, (x,y) \mid  x\equiv y \pmod{3} \,\} .$
 ...
 \begin{exercise}\label{exercise:EquivalenceRelationsChap:DrawBinRelExer2}
...
\begin{example}\label{example:EquivalenceRelationsChap:partition1}
\begin{enumerate}[(a)]
...
\begin{example}\label{example:EquivalenceRelationsChap:partition2}
\begin{enumerate}[(a)]
...
\begin{exercise}\label{exercise:EquivalenceRelationsChap:RelGraphR2}
...
\begin{example}\label{example:EquivalenceRelationsChap:relfrompart1}
...
\begin{exercise}\label{exercise:EquivalenceRelationsChap:relfrompart2}
...
\begin{prop}\label{proposition:EquivalenceRelationsChap:partbinrel} Given a partition $\mathcal{P}$ on set $A$, define a binary relation of $A$ as $a \rel b$ iff there exists a subset $C \in \mathcal{P}$ such that $a$ and $b$ are both elements of $C$, then the binary relation, $\rel$, satisfies the following 3 properties:
\begin{enumerate}[(a)]
...
\begin{prop}\label{proposition:EquivalenceRelationsChap:parteqrel} Given a partition $\mathcal{P}$ on set $A$, define a binary relation $\sim$ on $A$ as follows: 
\[a \sim b \quad \iff \quad \exists C \in \mathcal{P}, ( a \in C \text{ and } b \in C ).\]  
...
\begin{example}\label{example:EquivalenceRelationsChap:binrelR} \ 
...
\begin{example}\label{example:EquivalenceRelationsChap:relonB}
...
\begin{example}\label{example:EquivalenceRelationsChap:transnotrefsym}
...
\begin{exercise}\label{exercise:EquivalenceRelationsChap:BinRelSomePropsEx}
...
\begin{example}\label{example:EquivalenceRelationsChap:binrelsquare}
...
\begin{example}\label{example:EquivalenceRelationsChap:NxNEquivRelEg}
...
\begin{exercise}\label{exercise:EquivalenceRelationsChap:pattern}
...
\begin{example}\label{example:EquivalenceRelationsChap:MoreEquivRelEgs}
\begin{enumerate}[(a)]
...
\begin{exercise}\label{exercise:EquivalenceRelationsChap:partitionfunction}
...
\begin{prop}\label{proposition:EquivalenceRelationsChap:PartToFunc}
...
\begin{exercise}\label{exercise:EquivalenceRelationsChap:realfunction}
...
\begin{prop}\label{proposition:EquivalenceRelationsChap:FuncIsRange}
...
\begin{exercise}\label{exercise:EquivalenceRelationsChap:Abdisjoint}
\begin{enumerate}[(a)]
...
\section{Obtaining partitions from equivalence relations\quad\sectionvideohref{LGU0Dhcozr8&list=PL2uooHqQ6T7PW5na4EX8rQX2WvBBdM8Qo&index=20}} \label{EquivalenceRelationsDefnSect}
...
\begin{example}\label{example:EquivalenceRelationsChap:EquivClassEg}
...
\begin{prop}\label{proposition:EquivalenceRelationsChap:EquivRelProps}
Suppose $\sim$ is an equivalence relation on a set~$S$. Then:
\begin{enumerate}[(a)]
\item \label{EquivRelProps-aIna}
...
\begin{example}\label{example:EquivalenceRelationsChap:EquivClassPartEg}
...
\begin{prop}\label{proposition:EquivalenceRelationsChap:EquivRel->Part}
...
\begin{exercise}\label{exercise:EquivalenceRelationsChap:ECtoP}
...
\begin{exercise}\label{exercise:EquivalenceRelationsChap:ECtoP2}
...
\begin{exercise}\label{exercise:EquivalenceRelationsChap:equivalencePartition}
...
\sectionvideohref{DsGQvzpUb1Q&list=PL2uooHqQ6T7PW5na4EX8rQX2WvBBdM8Qo&index=22&t=0s}} \label{EquivalenceRelationsModArithSect}
...
\begin{prop}\label{proposition:EquivalenceRelationsChap:equivModN}
...
\begin{exercise}\label{exercise:EquivalenceRelationsChap:compareCaley}
\begin{enumerate}[(a)]
\item
...
\begin{exercise}\label{exercise:EquivalenceRelationsChap:58}
\begin{enumerate}[(a)]
