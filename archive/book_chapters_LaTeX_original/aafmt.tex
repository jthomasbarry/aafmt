...
\newenvironment{defn}[1]
  {\refstepcounter{equation}{\bigskip\noindent\bf Definition~\arabic{chapter}.\arabic{section}.\arabic{equation}.}\label{definition:\chaplabel:#1}}
...
\vfill
\copyright 2013,2014, 2015, 2018, 2020, 2022 by Justin Hill and Chris Thron. Some rights reserved.\\
...
\input{ modular_arithmetic_divisibility}
...
\include{intro_to_rings}
\include{intro_to_rings_hints}
