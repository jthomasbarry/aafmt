...
%%%%(c)
%%%%(c)
\chap{Further topics in Cryptography}{NOTUSED_FurtherTopicsCryptography}
\section{Diffie-Hellman Key Exchange}\label{sec:NOTUSED_FurtherTopicsCryptography:DHKE1}
...
\section{Elliptic Curve Cryptography}\label{sec:NOTUSED_FurtherTopicsCryptographyECC2}
