...
If Moses and Rachael would like to communicate a message using ECC, then they could use an agreed upon code table and elliptic curve.  Each character of the message would correspond to a point on the elliptic curve.
