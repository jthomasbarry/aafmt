...
Performing exponentiation over a modulus is called \emph{discrete exponentiation}\index{discrete exponentiation! in cryptogaphy} and can quickly become incalculable, however you can overcome this by creating a repeated squaring formula using an excel spreadsheet.  See Exercise \ref{exercise:crypt:power} for instructions on how to create a spreadsheet to compute the following exercises.
