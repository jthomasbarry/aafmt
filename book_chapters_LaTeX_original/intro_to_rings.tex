...
\section{Definitions and Examples \quad\sectionvideohref{xKUyYlAq24c&feature=youtu.be}}\label{sec:rings:Definitions and Examples}
...
&=A\cdot(((B+C)\cdot B)+((B+C)\cdot(-C))) & \text{\underline{$<1>$}}\\
&=A\cdot((B\cdot B+C\cdot B)+(B\cdot (-C)+C\cdot (-C))) & \text{\underline{$<2>$}}\\
&=A\cdot((B\cdot B+B\cdot C)+((-C)\cdot(B)+(-C)\cdot C))  & \text{\underline{$<3>$}}\\
&=A\cdot(B\cdot B+(B\cdot C+(-C)\cdot(B)+(-C)\cdot C))  & \text{\underline{$<3>$}}\\
&=A\cdot(B\cdot B+(B\cdot C+B\cdot(-C))+(-C)\cdot C)) & \text{\underline{$<4>$}}\\
&=A\cdot(B\cdot B+(B\cdot(C+(-C))+(-C)\cdot C)) & \text{\underline{$<5>$}}\\
&=A\cdot(B\cdot B+(B\cdot(0)+(-C)\cdot C)) & \text{\underline{$<6>$}}\\
&=A\cdot(B\cdot B+(0+(-C)\cdot C)) & \text{\underline{$<7>$}}\\
&=A\cdot(B\cdot B+(-C)\cdot C)) & \text{\underline{$<8>$}}
\end{align*}
\end{exercise}
...
\section{Extension Rings}\label{sec:extensionRings}
...
\section{Polynomials over fields}\label{sec:polyOverFields}
...
\section{References}\label{sec:rings:refs}
