...
%%%%(c)
%%%%(c)
\chap{Group Theory Applications (II): Further Topics in Cryptography}{further_crypt}
...
This chapter is authored by Moses Marmolejo, with revisions by C.T.
...
First we use the slope of the tangent line, using the samen formula we did for the real case in Example \ref{example:further_crypt:ec:realplus}:	
\[m = (3x_1^2 + a) \cdot (2y_1)^{-1}\]	
