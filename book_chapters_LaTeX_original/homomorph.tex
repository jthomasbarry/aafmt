...
We see some interesting things in  Example~\ref{example:homomorph:Z_8_i homomorph}. 
...
The set  $f^{-1} ( \{ e \})$ is  called the \term{
...
\begin{thmprop}~(\emph{First Isomorphism Theorem}\label{FirstIsoTheorem}\index{First Isomorphism
Theorem!for groups} 
