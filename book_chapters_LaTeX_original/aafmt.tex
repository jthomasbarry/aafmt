...
\author{Justin Hill, Chris Thron (eds), Thomas Judson, Dave Witte Morris, Joy Morris, A. J. Hildebrand (sources), Jennifer Lazarus, Holly Webb, Johnny Watts, David Weathers (chapter authors), Semi Harrison, Khoi Tran, Rachel McCoy (contributors)}
\begin{center}
\vspace{3.5cm}
...
\textbf {Jennifer Lazarus, Johnny Watts, Holly Webb, Mark Leech,  David Weathers, Moses Marmolejo} (TAMU-CT)\\
[0.4cm]
