...
\newcommand{\sectionvideohref}[2][4mm]{\href{https://www.youtube.com/watch?v=#2}{\raisebox{0.1mm}[0pt]{\includegraphics[height=#1]{images/video_camera}}}}
...
\newenvironment{example}[1]
  {\refstepcounter{equation}{\bigskip\noindent\bf Example~\arabic{chapter}.\arabic{section}.\arabic{equation}.}\label{example:\chaplabel:#1}}
  {\hspace\fill$\blacklozenge$\par\medskip}

%%% Other environments (CPT, Dec 22 2010) %%%
\newenvironment{prop}[1]
  {\refstepcounter{equation}{\bigskip\noindent\bf Proposition~\arabic{chapter}.\arabic{section}.\arabic{equation}.}\label{proposition:\chaplabel:#1}}
  {\par\medskip}

\newenvironment{exercise}[1]
  {\refstepcounter{equation}{\bigskip\noindent\bf Exercise~\arabic{chapter}.\arabic{section}.\arabic{equation}.}\label{exercise:\chaplabel:#1}}
  {\hspace\fill$\lozenge$\par\medskip}

\newenvironment{defn}
  {\refstepcounter{equation}{\bigskip\noindent\bf Definition~\arabic{chapter}.\arabic{section}.\arabic{equation}.}}
  {\hspace\fill$\triangle$\par\medskip}

\newenvironment{rem}
  {\refstepcounter{equation}{\bigskip\noindent\bf Remark~\arabic{chapter}.\arabic{section}.\arabic{equation}.}}
  {\hspace\fill$\triangle$\par\medskip}

\newenvironment{notation}
  {\refstepcounter{equation}{\bigskip\noindent\bf Notation~\arabic{chapter}.\arabic{section}.\arabic{equation}.}}
  {\hspace\fill$\triangle$\par\medskip}

%%% Legacy from P&C
\newenvironment{thm}
  {\refstepcounter{equation}{\bigskip\noindent\bf Proposition~\arabic{chapter}.\arabic{section}.\arabic{equation}.}}
  {\par\medskip}

\newenvironment{eg}
  {\refstepcounter{equation}{\bigskip\noindent\bf Example~\arabic{chapter}.\arabic{section}.\arabic{equation}.}}
  {\hspace\fill$\lozenge$\par\medskip}

\newenvironment{exer}
  {\refstepcounter{equation}{\bigskip\noindent\bf Exercise~\arabic{chapter}.\arabic{section}.\arabic{equation}.}}
  {\hspace\fill$\lozenge$\par\medskip}
...
\newenvironment{scratchwork}
  {\refstepcounter{equation}{\bigskip\noindent\bf Scratchwork~\arabic{chapter}.\arabic{section}.\arabic{equation}.}}
  {\hspace\fill$\triangle$\par\medskip}
...
\newenvironment{warn}
  {\refstepcounter{equation}{\bigskip\noindent\bf Warning~\arabic{chapter}.\arabic{section}.\arabic{equation}.}}
  {\hspace\fill$\lozenge$\par\medskip}
...
\renewenvironment{corollary}
  {\refstepcounter{equation}{\bigskip\noindent\bf Corollary~\arabic{chapter}.\arabic{section}.\arabic{equation}.}}
  {\par\medskip}
...
\author{Justin Hill, Chris Thron (eds), Thomas Judson, Dave Witte Morris, Joy Morris, A. J. Hildebrand (sources), Jennifer Lazarus, Mark Leech, Moses Marmolejo, Johnny Watts,David Weathers, Holly Webb  (chapter authors), Semi Harrison, Khoi Tran, Rachel McCoy (contributors)}
\begin{center}
\vspace{3.5cm}
...
\textbf {Jennifer Lazarus, Mark Leech, Moses Marmolejo, Johnny Watts,David Weathers, Holly Webb  } (TAMU-CT)\\
[0.4cm]
and additional contributions by\\[0.4cm]
\textbf{Rachel McCoy, Khoi Tran, Semi Harrison } (TAMU-CT)
\vfill
...
\vfill
\copyright 2013,2014, 2015, 2018 by Justin Hill and Chris Thron. Some rights reserved.\\
...
\include{complex}
\input{complex_hints}
\include{complex_study_guide}
\include{modular_arithmetic}
\input{modular_arithmetic_hints}
\include{modular_arithmetic_study_guide}
\include{set_chapter}
\input{set_chapter_hints}
\include{set_study_guide}
\include{functions}
\input{functions_hints}
\include{functions_study_guide}
\include{crypt}
\input{crypt_hints}
\include{crypt_study_guide}
\include{summation_notation}
\input{summation_notation_hints}
\include{summation_notation_study_guide}
\include{polyrings}
