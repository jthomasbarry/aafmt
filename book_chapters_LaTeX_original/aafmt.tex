...
\newenvironment{notation}[1]
  {\refstepcounter{equation}{\bigskip\noindent\bf Notation~\arabic{chapter}.\arabic{section}.\arabic{equation}.}\label{notation:\chaplabel:#1}}
  {\hspace\fill$\triangle$\par\medskip}
...
\author{Justin Hill, Chris Thron (eds), Thomas Judson, Dave Witte Morris, Joy Morris, A. J. Hildebrand (sources), Holly Webb, Johnny Watts, David Weathers, Semi Harrison, Khoi Tran, Rachel McCoy (contributors)}
\begin{center}
\vspace{3.5cm}
...
\textbf {Holly Webb, David Weathers, Johnny Watts, Semi Harrison, Khoi Tran, Rachel McCoy} (TAMU-CT)\\[0.4cm]
