\section{Solutions for ``PolynomialCodes''}
...
%\noindent\textbf{Exercise \ref{exercise:PolynomialCodes:poly2}}
%\begin{enumerate} [(a)]
%\item
...
%\noindent\textbf{Exercise \ref{exercise:PolynomialCodes:poly3l}}
%\begin{enumerate} [(a)]
%\item
...
%\noindent\textbf{Exercise \ref{exercise:PolynomialCodes:poly4}}
%\begin{enumerate} [(a)]
%\item
...
%\noindent\textbf{Exercise \ref{exercise:PolynomialCodes:poly5}}
%\begin{enumerate} [(a)]
%\item
% No
%\item 
...
%\noindent\textbf{Exercise \ref{exercise:PolynomialCodes:poly6}}
%\begin{enumerate} [(a)]
%\item
% $p(x)=2x$, $q(x)=2x^3+2$
%\item 
...
%\noindent\textbf{Exercise \ref{exercise:PolynomialCodes:mult2way}}
%\begin{enumerate} [(a)]
%\item 
% $x^3-2x^2-15x$
%\item
...
%\noindent\textbf{Exercise \ref{exercise:PolynomialCodes:multform}}
%\begin{enumerate} [(a)]
%\item 
...
%\noindent\textbf{Exercise \ref{exercise:PolynomialCodes:div1}}
%\begin{enumerate} [(a)]
%\item 
% $q(x)=x+5$, $r(x)=37$
%\item
