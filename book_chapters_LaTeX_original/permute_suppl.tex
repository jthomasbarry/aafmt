...
\noindent\textbf{Exercise \ref{exercise:permute:11}:} %KW added d, a-c were UG
...
\noindent\textbf{Exercise \ref{exercise:permute:long_cycle_perm2}:}
...
\noindent\textbf{Exercise \ref{exercise:permute:tab_to_cycle}:} %KW added d
...
\noindent\textbf{Exercise \ref{exercise:permute:cycle_to_tab}:} %KW added c
...
\noindent\textbf{Exercise \ref{exercise:permute:D6_cycles}:}\\ %KW added
...
\noindent\textbf{Exercise \ref{exercise:permute:dis_cycles_comm}:}  %KW updated e
...
\noindent\textbf{Exercise \ref{exercise:permute:cycle_comp_2}:} %KW added d
...
\noindent\textbf{Exercise \ref{exercise:permute:cycle_types}:} %KW added c
...
\noindent\textbf{Exercise \ref{exercise:permute:power of n-cycle1}:} %KW updated
...
\noindent\textbf{Exercise \ref{exercise:permute:cycle_order_1}:} %KW updated d
...
\noindent\textbf{Exercise \ref{exercise:permute:Sn_orders}:} %KW updated
...
\noindent\textbf{Exercise \ref{exercise:permute:example_transpositions2}:} %KW added f
...
\noindent\textbf{Exercise \ref{exercise:permute:prod_of_trans_1}:} %KW added f
...
\noindent\textbf{Exercise \ref{exercise:permute:inv_comps}:} %KW added f
...
\noindent\textbf{Exercise \ref{exercise:permute:switchyard1}:} %KW added
...
\noindent\textbf{Exercise \ref{exercise:permute:switchyard2}:} %KW added, still working on part def
...
\noindent\textbf{Exercise  \ref{exercise:permute:parity_right}:}\\ %KW need to do
...
\noindent\textbf{Exercise  \ref{exercise:permute:Ex95}:}\\ %KW updated
...
\noindent\textbf{Exercise  \ref{exercise:permute:Sn_even_odd}:}%KW added
...
\noindent\textbf{Exercise  \ref{exercise:permute:A_nGroupProps}:} %KW added
\begin{enumerate}[(a)]
\item
...
\noindent\textbf{Exercise  \ref{exercise:permute:B_nGroupProps}:}\\ %KW added
...
\noindent\textbf{Exercise  \ref{exercise:permute:A6_A7_A8}:} %KW added
