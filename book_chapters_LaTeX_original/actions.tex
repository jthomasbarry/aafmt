\chap{Group Actions }{GroupActions}
...
\begin{example}{Compat2} Recall $R$ and $X$ from Example~\ref{example:GroupActions:Actions2}, show that $(r_{40} \circ r_{30}).x_{15}=r_{40}.(r_{30}.x_{15})$.
\begin{equation*}
\begin{split}
...
\label{subsec:GroupActions:SymmetryOfPolyhedra:G_equiv}
...
\subsection{Euler's formula for regular polyhedra}
...
\label{subsec:GroupActions:Conjugation:PermutationAndCycleStructure}
