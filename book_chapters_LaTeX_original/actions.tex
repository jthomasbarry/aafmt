...
\caption{A paper cube to print, cut and fold (from \url{www.korthalsaltes.com}).}
 \label{fig:CubeFold}
\end{center}
\end{figure}
...
\caption{Tetrahedron to print, cut and fold ( from \url{www.korthalsaltes.com}).}
 \label{fig:TetraFold}
\end{center}
\end{figure}
...
Complete the following table to characterize the group elements of the rotational symmetries of a tetrahedron.  We show two rows--how many more are needed to complete the table?
...
When opposite points are lined up  on a vertical $z$ axis, the octahedron has no vertical or horizontal faces, as shown in Figure~\ref{fig:OctaRot}.  We denote a 90 degree counterclockwise rotation around the $z$ axis by $r_z$ (and similarly for rotations around the $x$, and $y$ axes).
...
We'll call this the \term{stabilizer counting formula}\index{Stabilizer!counting formula}.
...
\end {align*}
This powerful tool is known as \term{Euler's formula}\index{Euler's formula}.  Let's see how it can be used.
...
\section{Reflection symmetries of polyhedra}
