...
\item Define the relation $\rel$ on $\mathbb{C}$ as follows: $ z_1 \rel z_2$ iff $z_1 = |z_2|$. Is $\rel$ transitive? Is it reflexive? Is it symmetric? \hyperref[secEqRelChapHints]{(*Hint*)} 
...
\[x \rel_S y  \text{   iff   }  x \text{ and } y \text{ are in the same species} .\]
\end{eg}
...
\begin{thmprop} \label{EquivRelProps}
