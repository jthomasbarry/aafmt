...
\begin{defn} A \label{Partition}\term{partition}\index{Partition} $\mathcal{P}$ of a set~$A$ is a collection of nonempty subsets of~$A$, such that each element of~$A$ is in exactly one of the subsets in $\mathcal{P}$. In other words:
\begin{enumerate}[(a)]
...
\section{Examples of equivalence relations\quad\sectionvideohref{PL2uooHqQ6T7PW5na4EX8rQX2WvBBdM8Qo}}  \label{exampleEquivRel}
