...
\textbf {Johnny Watts, Holly Webb, Mark Leech,  David Weathers, Moses Marmolejo} (TAMU-CT)\\
[0.4cm]
...
\include{symmetries}
\include{symmetries_study_guide}
\input{symmetries_hints}
\include{permute}
\include{permute_study_guide}
\input{permute_hints}
\include{groups}
\include{groups_study_guide}
\input{groups_hints}
%\include{crypt_MM2}
%\input{crypt_MM_hints}
\include{equivalencerelations}
\input{equivalencerelations_hints}
\include{equivalencerelations_study_guide}
\include{cosets}
\include{cosets_study_guide}
\input{cosets_hints}
%\include{algcodes} 
