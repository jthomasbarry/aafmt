...
\end{prop}
Later we will use this proposition to show that all groups of  prime order $p$  are the ``same'' in some sense (see Section~\ref{sec:Isomorphism:Classification:CylicGroup}).
