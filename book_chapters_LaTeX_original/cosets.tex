...
Back in Chapter~\ref{modular} we defined modular equivalence (Definition~\ref{definition:ModularArithmetic:equivalence}), and in Proposition~\ref{proposition:ModularArithmetic:equivalence_alt} we gave an alternative characterization:
\medskip
...
Finally, we may use  the fact that $a \equiv r \pmod{n}$ and apply Exercise~\ref{exercise:ModularArithmetic:ModPower} in Section~\ref{ArithWithRems} to conclude that $a^{\phi(n)} \equiv 1 \pmod{n}$.
