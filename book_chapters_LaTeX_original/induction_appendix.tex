...
\subsection*{Induction proofs, type I: Sum/product formulas}
 \label{subsec:Induction:ProofPatternsAndPractice:TypeISumProd}
...
\label{subsec:Induction:ProofPatternsAndPractice:TypeII_Ineq}
...
\label{subsec:Induction:ProofPatternsAndPractice:TypeIII_NVariables}
...
\label{subsec:Induction:StrongInduction:Recurrences}
...
\label{subsec:Induction:StrongInduction:RepresentProblems}
